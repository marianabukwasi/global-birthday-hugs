...
const steps = [
  {
    ...
    desc: "Sign up for $2. $1 is your subscription, $1 goes to celebrate someone's birthday.",
    emoji: "✨",
  },
  {
    icon: Gift,
    title: "Contribute $1",
    desc: "Discover birthdays around the world. Send $1 with a photo and heartfelt message.",
    emoji: "🎁",
  },
  {
    icon: CreditCard,
    title: "Build Your Pot",
    desc: "Friends, family, and strangers contribute to your birthday pot all year long.",
    emoji: "🏺",
  },
  {
    icon: PartyPopper,
    title: "Celebrate!",
    desc: "On your birthday, receive your funds, a digital postcard, and maybe a gift experience!",
    emoji: "🎉",
  },
];
